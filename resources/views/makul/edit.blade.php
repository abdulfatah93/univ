                ...
                <div class="card-body">
                  ...
                  @csrf
                   ...
                   <label for=""> Nama Matakuliah</label>
                    <input type="text" name="nama_makul" class="form-control" placeholder="Tambah Nama Matakuliah" value="{{ is_null($makul) ? '' : $makul->nama_makul}}">
                   </div>

                   <div class="col">
                   <label for=""> SKS</label>
                    <input type="number" name="sks" class="form-control" placeholder="Tambah Sks Matakuliah"value="{{ is_null($makul) ? '' : $makul->sks}}" >
                   </div>
                   </div>
                   </div>
